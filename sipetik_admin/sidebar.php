            ...
            <nav class="sidebar d-flex flex-nowrap col-md-3 col-lg-2 d-md-inline bg-primary">
                <div class="d-flex flex-column flex-shrink-0 p-3">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        <li>
                            <a href="supir.php" class="nav-link link-dark btn-toggle"> Supir
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="bus.php" class="nav-link link-dark btn-toggle"> Bus
                            </a>
                        </li>
                        <li>
                            <a href="perjalanan.php" class="nav-link link-dark btn-toggle"> Perjalanan
                            </a>
                        </li>
                        <li>
                            <a href="jadwal.php" class="nav-link link-dark btn-toggle"> Jadwal
                            </a>
                        </li>
                    </ul>
                    <hr>
