...
<body>
    ...
    <nav class="navbar navbar-light fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Registerasi Admin</a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="login_admin.php">Login Admin</a>
              </li>
              <li class="nav-item">
            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
              <form action="" method="post">
                ...
                <div class="d-flex justify-content-around align-items-center mb-4">
                  <!-- Checkbox -->
                  <a href="login_admin.php">Sudah Punya Akun?</a>
                </div>
                <!-- Submit button -->
                <button type="submit" name="register_admin" class="btn btn-primary btn-lg btn-block">Sign in</button>
              </form>
            </div>
          </div>
        </div>
